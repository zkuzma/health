...
public class MessageConstant {
    ...
    public static final String QUERY_MEMBER_REPORT_SUCCESS = "查询会员数量成功";
    ...
    public static final String DELETE_CHECKITEM_LOSE = "检查项已经被检查组引用,不能删除!";
    public static final String DELETE_CHECKGROUP_LOSE = "此检查组与检查项目,或套餐有关联,不能删除!";
    public static final String DELETE_SETMEAL_LOSE = "此套餐与检查项目,或检查组有关联,不能删除!";
    ...
    public static final String DELETE_MENU_LOSE = "菜单已经被角色引用,不能删除!";
    ...
    public static final String DELETE_PERMISSION_LOSE = "权限已经被角色引用,不能删除!";
